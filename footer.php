<link rel="stylesheet" href="/Cinnamon/css/bootstrap.min.css">
	<link rel="stylesheet" href="/Cinnamon/css/animations.css">
	<link rel="stylesheet" href="/Cinnamon/css/font-awesome5.css">
	<link rel="stylesheet" href="/Cinnamon/css/fontello.css">
	<link rel="stylesheet" href="/Cinnamon/css/main.css" class="color-switcher-link">
	<link rel="stylesheet" href="/Cinnamon/css/shop.css" class="color-switcher-link">
	<script src="/Cinnamon/js/vendor/modernizr-2.6.2.min.js"></script>
    <script src="/Cinnamon/js/compressed.js"></script>
	<script src="/Cinnamon/js/main.js"></script>
				...
				<div class="container">
					<div class="row justify-content-center">
						...
						<div class="col-lg-4 col-md-6  animate" data-animation="fadeInUp">
							...
							<p>
							True cinnamon, or Ceylon cinnamon, is Sri Lanka's fragrant gift to the world—delicate, sweet, and prized above all others.
							</p>
						</div>
							...
							<div class="widget widget_icons_list">
								...
								<ul>
									<li class="icon-inline">
										...
										<p>No. 33/4 Mudduwa Road <br> Rathnapura , Sri Lanka</p>
									</li>
									<li class="icon-inline">
										<div class="icon-styled icon-top color-main fs-14">
									...
									<li class="icon-inline">
										...
										<p>
											<a href="#">industrieskw@gmail.com</a>
										</p>
									</li>
								</ul>
							</div>
