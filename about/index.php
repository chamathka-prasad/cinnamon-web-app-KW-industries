...
<body>
    ...
    <div id="canvas">
        <div id="box_wrapper">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 order-lg-1 order-2 pe-lg-5">
                            <h6 class="mb-3" style="color: #A16207; font-size: 1rem; letter-spacing: 2px;">WHO ARE WE?</h6>
                            <h2 class="mb-4" style="color: #5C3317; font-size: 2.5rem; font-weight: 700; font-family: 'Playfair Display', serif;">OUR STORY</h2>
                            <div class="mb-4 d-none d-md-block"></div>
                            <div class="mb-3 d-md-none"></div>

                            <!-- <p class="mb-4" style="color: #3a2615; font-size: 1.1rem; line-height: 1.7;">
                                What began as a dream 15 years ago has now grown into a purpose-driven company rooted in tradition, passion, and authenticity. From the very start, we were drawn to something special — Ceylon cinnamon, known worldwide as <span style="font-style: italic; font-weight: 600; color: #5C3317;">"True Cinnamon"</span> and celebrated as the finest cinnamon on Earth.
                            </p>

                            <p class="mb-4" style="color: #3a2615; font-size: 1.1rem; line-height: 1.7;">
                                Over the years, we've walked alongside the traditional makers — the guardians of this age-old craft — learning the delicate, time-honored process behind harvesting and preparing this rare spice. Their knowledge, passed down through generations, has become the foundation of everything we do.
                            </p>

                            <p class="mb-4" style="color: #3a2615; font-size: 1.1rem; line-height: 1.7;">
                                Today, that dream lives on in every stick we share. <strong style="color: #5C3317;">Pure Ceylon cinnamon — aromatic, delicate, and unmatched in quality</strong> — is at the heart of our story. And now, we're honored to bring that story to the world, one curl of cinnamon at a time.
                            </p> -->

                            <p class="mb-4" style="color: #3a2615; font-size: 1.1rem; line-height: 1.7;">
                                At the heart of our work is Ceylon cinnamon, also called <span style="font-style: italic; font-weight: 600; color: #5C3317;">"True Cinnamon"</span>, famous worldwide as the finest and purest cinnamon.
                            </p>

                            <p class="mb-4" style="color: #3a2615; font-size: 1.1rem; line-height: 1.7;">
                                We honor the age-old traditions of skilled makers who carefully harvest and prepare this rare spice using methods passed down through generations.
                            </p>

                            <p class="mb-4" style="color: #3a2615; font-size: 1.1rem; line-height: 1.7;">
                                Every cinnamon stick we share carries this rich heritage — pure, aromatic, and unmatched in quality — bringing a piece of Sri Lanka’s legacy to the world.
                            </p>
                            ...
                            <div class="d-flex flex-wrap align-items-center">
                                <a href="../contact/" class="btn me-3 mb-3" style="background-color: #A16207; color: white; padding: 10px 25px; border-radius: 30px;">Contact Us</a>
                                <span class="me-3 mb-3" style="color: #3a2615;">or</span>
                                <a href="../product/" class="btn mb-3" style="border: 2px solid #A16207; color: #5C3317; padding: 10px 25px; border-radius: 30px;">Go to Products</a>
                            </div>
                        </div>

                        <!-- Image Column -->
                        <div class="col-lg-6 order-lg-2 order-1 mb-5 mb-lg-0">
                            <div class="position-relative" style="border-radius: 10px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
                                <img src="cinnamonladysrilanka.png" alt="Cinnamon Factory"
                                    class="img-fluid w-100" style="height: 500px; object-fit: cover;">
                                <div class="position-absolute top-0 start-0 w-100 h-100" style="background: linear-gradient(rgba(0,0,0,0.1), rgba(0,0,0,0.1));"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section id="about-page" class="py-5" style="background-color: #f3e8d3;">
                <div class="container px-4">
                    ...
                    <div class="mx-auto" style="max-width: 1000px;">
                        ...
                        <div class="mb-5 animate__animated animate__fadeIn">
                            <h2 class="mb-4" style="color: #5C3317; font-size: 1.75rem; font-weight: 600;">Our Mission</h2>
                            <p class="mb-4" style="font-size: 1.1rem; color: #3a2615;">To be the preferred global supplier of authentic Ceylon cinnamon by:</p>
                            <ul class="mb-4 ps-4" style="list-style-type: disc; color: #3a2615;">
                                <li class="mb-2">Maintaining the highest quality standards from cultivation to delivery</li>
                                <li class="mb-2">Preserving traditional cinnamon processing techniques while adopting modern innovations</li>
                                <li class="mb-2">Ensuring sustainable and ethical sourcing practices</li>
                                <li class="mb-2">Building long-term partnerships based on trust and reliability</li>
                                <li>Promoting the unique benefits of Ceylon cinnamon worldwide</li>
                            </ul>
                        </div>

                        <!-- Our Team -->
                        <div class="mb-5 animate__animated animate__fadeIn">
                            <h2 class="mb-4" style="color: #5C3317; font-size: 1.75rem; font-weight: 600;">Our Team</h2>
                            <div class="row g-4">
                                <div class="col-md-6 col-lg-4 animate__animated animate__flipInX">
                                    <div class="p-4 rounded shadow-sm h-100" style="background-color: #f8f1e6; text-align: center;">
                                        <div class="rounded-circle overflow-hidden mx-auto mb-3" style="width: 130px; height: 130px;">
                                            <img src="ceo.png" alt="Kumar Wijesinghe" class="w-100 h-100 object-fit-cover">
                                        </div>
                                        <h3 class="mb-2" style="color: #5C3317; font-size: 1.25rem; font-weight: 600;">K.N. Fernando</h3>
                                        <p class="mb-3" style="color: #A16207;">Founder & CEO</p>
                                        <!-- <p style="color: #3a2615;">With over 30 years in the cinnamon industry, Kumar ensures our products meet the highest standards.</p> -->
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4 animate__animated animate__flipInX">
                                    <div class="p-4 rounded shadow-sm h-100" style="background-color: #f8f1e6; text-align: center;">
                                        <div class="rounded-circle overflow-hidden mx-auto mb-3" style="width: 130px; height: 130px;">
                                            <img src="dh.png" alt="Nayana Perera" class="w-100 h-100 object-fit-cover">
                                        </div>
                                        <h3 class="mb-2" style="color: #5C3317; font-size: 1.25rem; font-weight: 600;">A.U. Gajaweera</h3>
                                        <p class="mb-3" style="color: #A16207;">Co-Founder Founder & Director of Human Resources</p>
                                        <!-- <p style="color: #3a2615;">Nayana oversees our strict quality assurance processes at every stage of production.</p> -->
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4 animate__animated animate__flipInX">
                                    <div class="p-4 rounded shadow-sm h-100" style="background-color: #f8f1e6; text-align: center;">
                                        <div class="rounded-circle overflow-hidden mx-auto mb-3" style="width: 130px; height: 130px;">
                                            <img src="md.png" alt="Sanjeewa Bandara" class="w-100 h-100 object-fit-cover">
                                        </div>
                                        <h3 class="mb-2" style="color: #5C3317; font-size: 1.25rem; font-weight: 600;">K.U.B. Fernando</h3>
                                        <p class="mb-3" style="color: #A16207;">General Manager & Oversea Sales Manager</p>
                                        <!-- <p style="color: #3a2615;">Sanjeewa manages our international client relationships and logistics operations.</p> -->
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <style>
                            ...
                            .process-content {
                                padding: 20px;
                                background-color: rgba(248, 241, 230, 0.3);
                                border-radius: 8px;
            ...
            <section id="about-page" class="py-5" style="background-color:rgb(255, 255, 255);">
                <div class="container px-4">
                    ...
                    <div class="mx-auto" style="max-width: 1000px;">
                        ...
                        <div class="animate__animated animate__fadeIn">
                            <h2 class="mb-5 text-center" style="color: #5C3317; font-size: 1.75rem; font-weight: 600;">From Farm to Market</h2>
                            <div class="process-timeline">
                                ...
                                <div class="process-step">
                                    ...
                                    <div class="process-content">
                                        <h3 class="mb-3" style="color: #5C3317; font-size: 1.25rem; font-weight: 600;">Sustainable Cultivation</h3>
                                        <p style="color: #3a2615;">Our cinnamon is grown in carefully selected plantations across Sri Lanka's cinnamon belt, where ideal soil and climate conditions produce the finest quality bark.</p>
                                    </div>
                                </div>
                                ...
                                <div class="process-step">
                                    ...
                                    <div class="process-content">
                                        <h3 class="mb-3" style="color: #5C3317; font-size: 1.25rem; font-weight: 600;">Traditional Harvesting</h3>
                                        <p style="color: #3a2615;">Skilled workers carefully harvest the cinnamon bark during the optimal season, using techniques perfected over centuries.</p>
                                    </div>
                                </div>
                                ...
                                <div class="process-step">
                                    ...
                                    <div class="process-content">
                                        <h3 class="mb-3" style="color: #5C3317; font-size: 1.25rem; font-weight: 600;">Meticulous Processing</h3>
                                        <p style="color: #3a2615;">The bark undergoes careful peeling, rolling, and drying processes to develop its characteristic aroma, flavor, and appearance.</p>
                                    </div>
                                </div>
                                ...
                                <div class="process-step">
                                    ...
                                    <div class="process-content">
                                        <h3 class="mb-3" style="color: #5C3317; font-size: 1.25rem; font-weight: 600;">Quality Assurance</h3>
                                        <p style="color: #3a2615;">Each batch is rigorously tested for quality, purity, and safety before being graded and prepared for export.</p>
                                    </div>
                                </div>
                                ...
                                <div class="process-step">
                                    ...
                                    <div class="process-content">
                                        <h3 class="mb-3" style="color: #5C3317; font-size: 1.25rem; font-weight: 600;">Global Distribution</h3>
                                        <p style="color: #3a2615;">Our cinnamon is carefully packaged and shipped to clients worldwide, maintaining quality throughout the supply chain.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
