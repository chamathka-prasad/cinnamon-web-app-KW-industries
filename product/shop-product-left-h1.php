						...
						<main class="col-lg-7 col-xl-9 order-lg-2">
							<div class="product type-product ">
								...
								<div class="summary entry-summary">
									...
									<h1 class="product_title entry-title">H1 Cinnamon Product</h1>
									...
									<div>
										<p style="text-align: justify;">Strong and earthy, H1 is perfect for ground cinnamon production and industrial use, offering deep flavor over finesse.</p>
									</div>
	...
	-->
								<div class="woocommerce-tabs wc-tabs-wrapper">
									...
									<div class="panel wc-tab" id="tab-description" role="tabpanel" aria-labelledby="tab-title-description">
										...
										<p style="text-align: justify;">H1 is classified as a medium-grade cinnamon that is valued more for its flavor intensity than its appearance. With a relatively large diameter of 21–23 mm, it features a rough outer bark and a robust, strong taste with less natural sweetness. Due to its coarse form, H1 is not typically used for decorative or presentation purposes but is extensively used in the production of ground cinnamon, as well as in pharmaceutical and industrial applications.
											 Its strong profile and lower cost make it an economical choice for bulk processing where appearance is not a primary concern.</p>
									</div>
										...
										<table class="shop_attributes">
											...
											<tbody>
												...
												<tr>
													<th>Note</th>
													<td>
														<p> Not ideal for presentation purposes due to rough appearance.</p>
													</td>
												</tr>
											</tbody>
										</table>
