						...
						<main class="col-lg-7 col-xl-9 order-lg-2">
							<div class="product type-product ">
								...
								<div class="summary entry-summary">
									...
									<h1 class="product_title entry-title">Cinnamon Powder</h1>
									...
									<div>
										<p style="text-align: justify;">Finely ground and full of flavor, cinnamon powder is the versatile staple for baking, teas, skincare, and wellness blends.</p>
									</div>
	...
	-->
								<div class="woocommerce-tabs wc-tabs-wrapper">
									...
									<div class="panel wc-tab" id="tab-description" role="tabpanel" aria-labelledby="tab-title-description">
										...
										<p style="text-align: justify;">Cinnamon Powder is the most versatile and commonly used form of Ceylon cinnamon. Made by finely grinding cinnamon sticks from various grades, its quality can vary based on the source material used. The powder typically appears golden to brown in color and is renowned for its rich flavor and aroma. It finds broad usage in baking, cooking, teas, cosmetics, and even traditional medicine.
											 Its convenience and versatility make it a pantry staple and an essential ingredient across many industries. </p>
									</div>
										...
										<table class="shop_attributes">
											...
											<tbody>
												...
												<tr>
													<th>Note</th>
													<td>
														<p>Can be made from any grade of stick; quality depends on the source sticks used.</p>
													</td>
												</tr>
											</tbody>
										</table>
								...
								<section class="related products">
									...
									<ul class="products">
										...
										<li class="product">
										  <a
											class="woocommerce-LoopProduct-link"
											href="shop-product-left-c5specialt.php"
										  >
											<img src="pic.jpeg" alt="" />
							...
							<div class="widget woocommerce widget_product_categories">
								...
								<ul class="product-categories">
								  <li class="cat-item cat-parent">
									...
									<ul class="children">
									  ...
									  <li class="cat-item">
										<a href="shop-product-left-c5specialt.php">C5 Special</a>
									  </li>
									  <li class="cat-item">
							  ...
							  <div class="widget woocommerce widget_top_rated_products">
								...
								<ul class="product_list_widget">
								  ...
								  <li>
									<a href="shop-product-left-c5specialt.php">
