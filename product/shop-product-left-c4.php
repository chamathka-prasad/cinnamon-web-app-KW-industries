						...
						<main class="col-lg-7 col-xl-9 order-lg-2">
							<div class="product type-product ">
								...
								<div class="summary entry-summary">
									...
									<h1 class="product_title entry-title">C4 Cinnamon Product</h1>
									...
									<div>
										<p style="text-align: justify;">Cost-effective and flavorful, C4 cinnamon brings a golden brown touch to teas, spice powders, and everyday culinary creations.</p>
									</div>
	...
	-->
								<div class="woocommerce-tabs wc-tabs-wrapper">
									...
									<div class="panel wc-tab" id="tab-description" role="tabpanel" aria-labelledby="tab-title-description">
										...
										<p style="text-align: justify;">C4 cinnamon is widely recognized for its commercial popularity and affordability while still retaining a visually appealing and flavorful profile. With a slightly thicker diameter of 13–14 mm, this grade has a golden brown color and delivers a mild yet pleasant sweet aroma. It’s a preferred choice in the food industry for making cooking powders, tea blends, and general spice mixtures. 
											C4 strikes a perfect balance for businesses seeking a budget-friendly yet attractive and functional cinnamon option that doesn’t compromise on basic quality.</p>
									</div>
										...
										<table class="shop_attributes">
											...
											<tbody>
												<tr>
													<th>Taste</th>
													<td>
														<p>  Mild aroma with a sweet touch </p>
													</td>
												</tr>
												<tr>
													<th>Note</th>
													<td>
														<p> Cost-effective and still visually appealing</p>
													</td>
												</tr>
											</tbody>
										</table>
								...
								<section class="related products">
									...
									<ul class="products">
										...
										<li class="product">
										  ...
										  >
											<img src="pic.jpeg" alt="" />
											<h2 class="producthead"> Cinaemon Powder</h2>
											<!-- <div class="star-rating">
											  <span style="width: 90%"
