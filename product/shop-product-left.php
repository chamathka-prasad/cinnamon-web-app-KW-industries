						...
						<main class="col-lg-7 col-xl-9 order-lg-2">
							<div class="product type-product ">
								...
								<div class="summary entry-summary">
									...
									<h1 class="product_title entry-title">ALBA Cinnamon Product</h1>
									...
									<div>
										<p style="text-align: justify;">Delicate and luxurious, ALBA cinnamon offers the highest quality with a pale golden hue and sweet, mild aroma for gourmet dishes and herbal remedies.</p>
									</div>
	...
	-->
								<div class="woocommerce-tabs wc-tabs-wrapper">
									...
									<div class="panel wc-tab" id="tab-description" role="tabpanel" aria-labelledby="tab-title-description">
										...
										<p style="text-align: justify;">ALBA is considered the gold standard among Ceylon cinnamon grades, prized for its exceptional quality and delicacy.
											 This top-tier cinnamon has a diameter of no more than 6 mm and features a very thin, pale golden appearance that sets it apart. Known for its mild, sweet, and highly aromatic flavor, ALBA is primarily used in premium food and beverage products, luxury culinary applications, and high-end herbal medicines. 
											</p> 
									</div>
										...
										<table class="shop_attributes">
											...
											<tbody>
												<tr>
													<th>Taste</th>
													<td>
														<p> Mild, Sweet, and Aromatic </p>
													</td>
												</tr>
												<tr>
													<th>Note</th>
													<td>
														<p> It is considered the gold standard among Ceylon Cinnamon grades</p>
													</td>
												</tr>
											</tbody>
										</table>
