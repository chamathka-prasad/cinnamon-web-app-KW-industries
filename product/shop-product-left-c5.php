						...
						<main class="col-lg-7 col-xl-9 order-lg-2">
							<div class="product type-product ">
								...
								<div class="summary entry-summary">
									...
									<h1 class="product_title entry-title">C5 Cinnamon Product</h1>
									...
									<div>
										<p style="text-align: justify;">Bold, sweet, and aromatic—C5 cinnamon is a top choice for food processing and exports with excellent flavor and value.</p>
									</div>
	...
	-->
								<div class="woocommerce-tabs wc-tabs-wrapper">
									...
									<div class="panel wc-tab" id="tab-description" role="tabpanel" aria-labelledby="tab-title-description">
										...
										<p style="text-align: justify;">C5 cinnamon is one of the most in-demand grades in both local and international markets due to its outstanding balance of quality and affordability. Featuring a deep yellow color and a diameter ranging from 10 to 12 mm, this grade delivers a sweet, aromatic flavor that’s perfect for various culinary and processing needs. 
											Commonly used in spice blends, food production, and as an export commodity, 
											C5 is a favorite among manufacturers and retailers looking for dependable, high-quality cinnamon.</p>
									</div>
										...
										<table class="shop_attributes">
											...
											<tbody>
												<tr>
													<th>Taste</th>
													<td>
														<p>  Sweet and highly aromatic </p>
													</td>
												</tr>
												<tr>
													<th>Note</th>
													<td>
														<p>  Often chosen for its good price-to-quality ratio</p>
													</td>
												</tr>
											</tbody>
										</table>
