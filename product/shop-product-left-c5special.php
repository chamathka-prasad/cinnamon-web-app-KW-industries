				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-12 text-center text-sm-left">
							<h1>C5 Special Cinnamon Product</h1>
							<ol class="breadcrumb">
						...
						<main class="col-lg-7 col-xl-9 order-lg-2">
							<div class="product type-product ">
								...
								<div class="summary entry-summary">
									...
									<h1 class="product_title entry-title">C5 Special Cinnamon Product</h1>
									...
									<div>
										<p style="text-align: justify;">Rich aroma and light brown charm make C5 Special the go-to for luxury teas, gourmet blends, and high-end culinary experiences.</p>
									</div>
	...
	-->
								<div class="woocommerce-tabs wc-tabs-wrapper">
									...
									<div class="panel wc-tab" id="tab-description" role="tabpanel" aria-labelledby="tab-title-description">
										...
										<p style="text-align: justify;">C5 Special ranks as the third highest grade of Ceylon cinnamon in Sri Lanka. It strikes an excellent balance between premium quality and wider availability. With a diameter slightly larger than Alba, ranging from 7 to 9 mm, and a light brown hue, C5 Special delivers a rich and sweet aromatic profile.
											 This grade is often chosen for its versatility and consistent quality, making it suitable for specialty teas, luxury spice blends, and high-end culinary applications.
											 </p>
									</div>
										...
										<table class="shop_attributes">
											...
											<tbody>
												<tr>
													<th>Taste</th>
													<td>
														<p>  Rich and Sweet aroma </p>
													</td>
												</tr>
												<tr>
													<th>Note</th>
													<td>
														<p> This grade balances high quality and availability</p>
													</td>
												</tr>
											</tbody>
										</table>
