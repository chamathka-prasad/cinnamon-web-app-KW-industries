						...
						<main class="col-lg-7 col-xl-9 order-lg-2">
							<div class="product type-product ">
								...
								<div class="images" data-columns="4">
									<figure>
										<div data-thumb="pic2.jpg">
											<a href="pic2.jpg">
												<img src="pic2.jpg" alt="" data-caption="" data-src="pic2.jpg" data-large_image="pic2.jpg" data-large_image_width="1000" data-large_image_height="1000">
											</a>
										</div>
										<div data-thumb="pic2.jpeg">
											<a href="pic2.jpeg">
												<img src="pic2.jpeg" alt="" data-caption="" data-src="pic2.jpeg" data-large_image="pic2.jpeg" data-large_image_width="1000" data-large_image_height="1000">
											</a>
										</div>
										<div data-thumb="pic2.jpg">
											<a href="pic2.jpg">
										...
										<div data-thumb="pic2.webp">
											<a href="pic2.webp">
												<img src="pic2.webp" alt="" data-caption="" data-src="pic2.webp" data-large_image="pic2.webp" data-large_image_width="1000" data-large_image_height="1000">
											</a>
										</div>
								...
								<div class="summary entry-summary">
									...
									<h1 class="product_title entry-title">H2 Cinnamon Product</h1>
									...
									<div>
										<p style="text-align: justify;">Golden yellow and aroma-rich, H2 cinnamon strikes the ideal balance between quality and affordability for bark-form lovers.</p>
									</div>
	...
	-->
								<div class="woocommerce-tabs wc-tabs-wrapper">
									...
									<div class="panel wc-tab" id="tab-description" role="tabpanel" aria-labelledby="tab-title-description">
										...
										<p style="text-align: justify;">H2 cinnamon is a popular grade in its natural bark form and is frequently chosen by industries and buyers who value aroma over aesthetic perfection. Characterized by its golden yellow color, this grade is appreciated for its balanced fragrance and cost-effectiveness. It serves a variety of uses in exports and is commonly sold in bulk form. While it may lack the visual refinement of higher-grade cinnamon, H2 offers an aromatic experience that appeals to traditional markets and cinnamon bark enthusiasts.
											 It is especially valued in contexts where affordability and strong aroma are prioritized.</p>
									</div>
										...
										<table class="shop_attributes">
											...
											<tbody>
												<!-- <tr>
													<th>Taste</th>
													<td>
														<p>  Strong flavor with less sweetness. </p>
													</td>
												</tr> -->
												<tr>
													<th>Note</th>
													<td>
														<p> Offers a balance between flavor and cost for cinnamon bark lovers</p>
													</td>
												</tr>
											</tbody>
										</table>
											...
											<div id="review_form_wrapper">
												<div id="review_form">
													<div id="respond" class="comment-respond">
														<span id="reply-title" class="comment-reply-title" style="margin-top: -30px; font-family: 'Playfair Display', serif;" >Add a review <small>
														...
														<form action="/" method="post" id="commentform" class="comment-form" novalidate="">
															...
															<p class="comment-form-email">
																<label for="email66">Email <span class="required">*</span>
													...
													<!-- #respond -->
													<div id="reviews-wall" style="margin-top: 30px;">
														<h4 style="font-family: 'Playfair Display', serif;">Customer Reviews</h4>
								...
								<section class="related products">
									<h6 class="above">own production</h6>
